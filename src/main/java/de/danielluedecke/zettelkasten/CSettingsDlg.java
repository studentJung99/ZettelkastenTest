...
public class CSettingsDlg extends javax.swing.JDialog {
	...
	private final org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
			...
			.getResourceMap(CSettingsDlg.class);
	/**
	...
	public CSettingsDlg(java.awt.Frame parent, Settings s, Daten d, AutoKorrektur ac, Synonyms sy, StenoData stn) {
		...
		try {
			if (lang.equalsIgnoreCase("de")) {
				...
				jComboBoxLocale.setSelectedIndex(4);
			} else {
	...
	private void initListeners() {
		...
		jButtonHighlightStyle.addActionListener(evt -> {
			if (null == highlightSettingsDlg) {
				highlightSettingsDlg = new CHighlightSearchSettings(null, settings,
		...
		jButtonHighlightLivesearchStyle.addActionListener(evt -> {
			if (null == highlightSettingsDlg) {
				highlightSettingsDlg = new CHighlightSearchSettings(null, settings,
						HtmlUbbUtil.HIGHLIGHT_STYLE_LIVESEARCH);
				highlightSettingsDlg.setLocationRelativeTo(null);
			}
			ZettelkastenApp.getApplication().show(highlightSettingsDlg);
			if (!highlightSettingsDlg.isCancelled()) {
	...
	/**
	 * Initiates the combo-box that hold the values for the manual timestamps that
	 * can be inserted when editing new entries (CNewEntry-dialog).
	 */
	...
	private void editCSS(int what) {
		...
		if (null == biggerEditDlg) {
			...
			biggerEditDlg = new CBiggerEditField(null, settings, resourceMap.getString("editCSS.text"), css, "",
					Constants.EDIT_STYLESHEET);
			// center window
	 ...
	 * choose which type of font (main-font, font for authors, for lists, for tables
	 * etc.) he or she wants to change.
	 */
	private void initComboboxFonts() {
		...
		jComboBoxFonts.addItem(
				resourceMap.getString("desktopheaderfontText") + ": " + getFontDataForCombobox(desktopheaderfont));
		jComboBoxFonts.addItem(
				resourceMap.getString("desktopcommentfontText") + ": " + getFontDataForCombobox(desktopcommentfont));
		jComboBoxFonts.addItem(resourceMap.getString("desktopitemheaderfontText") + ": "
				+ getFontDataForCombobox(desktopitemheaderfont));
		jComboBoxFonts
				.addItem(resourceMap.getString("desktopitemfontText") + ": " + getFontDataForCombobox(desktopitemfont));
		jComboBoxFonts.addItem(resourceMap.getString("quotefontText") + ": " + getFontDataForCombobox(quotefont));
		jComboBoxFonts
				.addItem(resourceMap.getString("entryheaderfontText") + ": " + getFontDataForCombobox(entryheaderfont));
		jComboBoxFonts.addItem(
				resourceMap.getString("appendixheaderfontText") + ": " + getFontDataForCombobox(appendixheaderfont));
	...
	private void registerFileExtension() {
		try {
			...
			JOptionPane.showMessageDialog(null, resourceMap.getString("errorRegistryMsg"),
					resourceMap.getString("errorRegistryTitle"), JOptionPane.PLAIN_MESSAGE);
		} catch (NotSupportedOSException e) {
			Constants.zknlogger.log(Level.WARNING, e.getLocalizedMessage());
		}
	}
	 ...
	 * value is stored as string, this method converts the hex-string into a
	 * rgb-Color-value.
	 *
	 ...
	 *
	 * @param c the new color value, received from the color-chooser and converted
	 *          to a hex-string
	 */
	...
	/**
	 * This method opens the font-choose-dialog, passing the selected font from the
	 * combobox as parameter to set as initial values.
	 */
	@Action
	...
	/**
	 * Finally, when the user presses the apply-button, all settings are saved. this
	 * is done in this method. when all changes have been saved, the window will be
	 * closed and disposed.
	 */
	...
	public void applyChanges() {
		...
		try {
			...
			if ((imgresizewidth < 5) || (imgresizewidth > 9999) || (imgresizeheight < 5) || (imgresizeheight > 9999)) {
				...
				JOptionPane.showMessageDialog(null, resourceMap.getString("errImgSizeMsg"),
						resourceMap.getString("errImgSizeTitle"), JOptionPane.PLAIN_MESSAGE);
		...
		try {
			...
			if ((spacinghor < 0) || (spacinghor > 25) || (spacingver < 0) || (spacingver > 25)) {
				// tell the user which setting is wrong
				JOptionPane.showMessageDialog(null, resourceMap.getString("errSpacingSizeMsg"),
						resourceMap.getString("errSpacingSizeTitle"), JOptionPane.PLAIN_MESSAGE);
				// select the appropriate tabbed pane
				jTabbedPane1.setSelectedIndex(1);
				// and set input focus to textfield
	 ...
	 * CSS-definitions, we convert the Font-properties to CSS-properties here. We
	 * need this for setting up the HTML-page that displays entries. The formatting
	 * is done via style-tags and CSS, so we need the CSS-definitions...
	 *
	...
	private void initComponents() {
		...
		jComboBoxShowAtStartup = new javax.swing.JComboBox<String>();
		...
		jComboBoxLAF = new javax.swing.JComboBox<String>();
		...
		jComboBoxManualTimestamp = new javax.swing.JComboBox<String>();
		jComboBoxLocale = new JComboBox<String>();
		jLabel15 = new javax.swing.JLabel();
		jCheckBoxShowToolbar = new javax.swing.JCheckBox();
		jCheckBoxShowAllIcons = new javax.swing.JCheckBox();
		jLabel10 = new javax.swing.JLabel();
		jComboBoxIconTheme = new javax.swing.JComboBox<String>();
		...
		jComboBoxFonts = new javax.swing.JComboBox<String>();
		jButtonFont = new javax.swing.JButton();
		jLabelColor = new javax.swing.JLabel();
		jButtonFontcolor = new javax.swing.JButton();
		jLabel19 = new javax.swing.JLabel();
		jComboBoxBackgroundColors = new javax.swing.JComboBox<String>();
		...
		javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance().getContext()
				.getActionMap(CSettingsDlg.class, this);
		...
		jCheckBoxSearchWithoutFormatTags
				.setToolTipText(resourceMap.getString("jCheckBoxSearchWithoutFormatTags.toolTipText")); // NOI18N
		...
		jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel3Layout.createSequentialGroup().addContainerGap().addGroup(jPanel3Layout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jCheckBoxSystray)
						.addComponent(jCheckBoxRegistry)
						.addGroup(jPanel3Layout.createSequentialGroup().addGroup(jPanel3Layout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jCheckBoxSteno).addComponent(jCheckBoxAutocorrect)
								.addGroup(jPanel3Layout.createSequentialGroup().addGap(21, 21, 21)
										.addComponent(jLabel13)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(jTextFieldBackupPath, javax.swing.GroupLayout.PREFERRED_SIZE, 261,
						...
						.addComponent(jCheckBoxExtraBackup).addComponent(jCheckBoxAutobackup)
						.addGroup(jPanel3Layout.createSequentialGroup().addComponent(jLabel3)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jComboBoxShowAtStartup, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGroup(jPanel3Layout.createSequentialGroup().addComponent(jCheckBoxSynonym)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jButtonSynonymEdit))
						.addComponent(jCheckBoxFillNewEntries).addComponent(jCheckBoxSearchWithoutFormatTags)
						.addComponent(jCheckBoxAllToHist).addComponent(jCheckBoxAutoCompleteTags)
						.addComponent(jCheckBoxUseMarkdown))
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel3Layout.createSequentialGroup().addContainerGap()
						.addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel3).addComponent(jComboBoxShowAtStartup,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(18, 18, 18).addComponent(jCheckBoxAutobackup)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jCheckBoxExtraBackup)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jTextFieldBackupPath, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabel13).addComponent(jButtonBrowseBackup))
						.addGap(18, 18, 18)
						.addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jCheckBoxAutocorrect).addComponent(jButtonEditAutokorrekt))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jCheckBoxSteno).addComponent(jButtonEditSteno))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jCheckBoxAutoCompleteTags)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jCheckBoxUseMarkdown).addGap(18, 18, 18)
						.addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jCheckBoxSynonym).addComponent(jButtonSynonymEdit))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
		...
		jFormattedTextFieldImgWidth.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(
		...
		jFormattedTextFieldImgHeight.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(
				new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("####"))));
		...
		jComboBoxLocale.setModel(new javax.swing.DefaultComboBoxModel<String>(
				new String[] { "English", "German (Deutsch)", "Spanish (Espanol)", "Portuguese (Brazil)", "Korean (한국어)" }));
		...
		jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel2Layout.createSequentialGroup().addContainerGap().addGroup(jPanel2Layout
						...
						.addGroup(jPanel2Layout.createSequentialGroup().addComponent(jLabel12)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jComboBoxManualTimestamp, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addComponent(jCheckBoxIconText).addComponent(jCheckBoxShowToolbar)
						.addGroup(jPanel2Layout.createSequentialGroup().addComponent(jLabel10)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jComboBoxIconTheme, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGroup(jPanel2Layout.createSequentialGroup().addComponent(jLabel1)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jComboBoxLAF, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGroup(jPanel2Layout.createSequentialGroup().addComponent(jLabel15)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jComboBoxLocale, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addComponent(jCheckBoxShowTableBorder).addComponent(jCheckBoxFootnote)
								...
								.addGroup(jPanel2Layout.createSequentialGroup().addGap(27, 27, 27)
										...
										.addGroup(jPanel2Layout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addComponent(jFormattedTextFieldImgWidth,
														javax.swing.GroupLayout.Alignment.TRAILING,
														javax.swing.GroupLayout.PREFERRED_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addComponent(jFormattedTextFieldImgHeight,
														javax.swing.GroupLayout.Alignment.TRAILING,
														javax.swing.GroupLayout.PREFERRED_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.PREFERRED_SIZE)))
								.addComponent(jCheckBoxImgResize))
						.addComponent(jCheckBoxShowEntryHeadline).addComponent(jCheckBoxUseMacBackgroundColor))
						.addContainerGap()));
		jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel2Layout.createSequentialGroup().addContainerGap()
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel15).addComponent(jComboBoxLocale,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel1).addComponent(jComboBoxLAF,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						...
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel12).addComponent(jComboBoxManualTimestamp,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						...
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel10).addComponent(jComboBoxIconTheme,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jCheckBoxImgResize)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel4).addComponent(jFormattedTextFieldImgWidth,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel6).addComponent(jFormattedTextFieldImgHeight,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						...
						.addComponent(jCheckBoxFootnoteBraces)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jCheckBoxJumpToTab).addContainerGap()));
		...
		jPanel5Layout.setHorizontalGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel5Layout.createSequentialGroup().addGroup(jPanel5Layout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(jPanel5Layout.createSequentialGroup().addGap(10, 10, 10).addComponent(jLabel19)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jComboBoxBackgroundColors, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jLabelTableColor, javax.swing.GroupLayout.PREFERRED_SIZE, 27,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jButtonTableBackgroundColor, javax.swing.GroupLayout.PREFERRED_SIZE, 24,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGroup(jPanel5Layout.createSequentialGroup().addGap(10, 10, 10).addComponent(jLabel2)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jComboBoxFonts, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jLabelColor, javax.swing.GroupLayout.PREFERRED_SIZE, 27,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jButtonFont, javax.swing.GroupLayout.PREFERRED_SIZE, 24,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jButtonFontcolor, javax.swing.GroupLayout.PREFERRED_SIZE, 24,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGroup(jPanel5Layout.createSequentialGroup().addContainerGap()
								.addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addComponent(jLabel5).addComponent(jLabel20).addComponent(jLabel21)
										.addComponent(jCheckBoxEntryCSS).addComponent(jCheckBoxDesktopCSS))
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
								.addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addComponent(jButtonDesktopCSS).addComponent(jButtonEntryCss)
										.addComponent(jButtonHighlightStyle).addComponent(jButtonHighlightKeywordStyle)
										.addComponent(jButtonHighlightLivesearchStyle)
										.addComponent(jButtonResetEntryCSS).addComponent(jButtonResetDesktopCSS))))
						.addContainerGap()));
		jPanel5Layout
				.setVerticalGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(jPanel5Layout.createSequentialGroup().addContainerGap().addGroup(jPanel5Layout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER).addComponent(jLabel2)
								.addComponent(jComboBoxFonts, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jButtonFont).addComponent(jButtonFontcolor)
								.addComponent(jLabelColor, javax.swing.GroupLayout.PREFERRED_SIZE, 24,
										javax.swing.GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addGroup(jPanel5Layout
										...
										.addGroup(jPanel5Layout
												...
												.addComponent(jLabel19).addComponent(jComboBoxBackgroundColors,
														javax.swing.GroupLayout.PREFERRED_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.PREFERRED_SIZE))
										.addComponent(jLabelTableColor, javax.swing.GroupLayout.PREFERRED_SIZE, 27,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(jButtonTableBackgroundColor,
												javax.swing.GroupLayout.PREFERRED_SIZE, 24,
												javax.swing.GroupLayout.PREFERRED_SIZE))
								.addGap(18, 18, 18)
								.addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(jLabel5).addComponent(jButtonHighlightStyle))
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(jLabel20).addComponent(jButtonHighlightKeywordStyle))
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(jLabel21).addComponent(jButtonHighlightLivesearchStyle))
								.addGap(18, 18, 18)
								.addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(jCheckBoxEntryCSS).addComponent(jButtonEntryCss))
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jButtonResetEntryCSS).addGap(18, 18, 18)
								.addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(jCheckBoxDesktopCSS).addComponent(jButtonDesktopCSS))
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jButtonResetDesktopCSS).addContainerGap()));
		...
		jPanel11Layout.setHorizontalGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel11Layout.createSequentialGroup().addContainerGap().addGroup(jPanel11Layout
						...
						.addGroup(jPanel11Layout.createSequentialGroup()
								...
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addComponent(jSpinnerDistHor, javax.swing.GroupLayout.Alignment.TRAILING,
												javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(jSpinnerDistVer, javax.swing.GroupLayout.Alignment.TRAILING,
												javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.PREFERRED_SIZE)))
						.addComponent(jCheckBoxShowHorGrid).addComponent(jCheckBoxShowVerGrid)
						.addComponent(jSliderFontSize, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addComponent(jSliderTextfields, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						...
						.addGroup(jPanel11Layout.createSequentialGroup()
								...
								.addGroup(jPanel11Layout
										...
										.addComponent(jButtonDesktopFont, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(jButtonListFont, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
						.addContainerGap()));
				...
				.addGroup(jPanel11Layout.createSequentialGroup().addContainerGap().addComponent(jCheckBoxShowHorGrid)
						...
						.addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
								.addComponent(jLabel7, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(jSpinnerDistHor, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
								.addComponent(jLabel8, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(jSpinnerDistVer, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(18, 18, 18).addComponent(jLabel9).addGap(0, 0, 0)
						.addComponent(jSliderFontSize, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(18, 18, 18).addComponent(jLabel23)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jSliderDesktopFontSize, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						...
						.addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel16).addComponent(jButtonListFont))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabelFontDeskLayout).addComponent(jButtonDesktopFont))
						.addContainerGap()));
		...
		jPanel7Layout.setHorizontalGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel7Layout.createSequentialGroup().addContainerGap().addGroup(jPanel7Layout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								jPanel7Layout.createSequentialGroup().addGap(6, 6, 6).addComponent(jCheckBoxUseXDGOpen))
						.addGroup(jPanel7Layout.createSequentialGroup()
								.addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addComponent(jLabel17).addComponent(jLabel14).addComponent(jLabel18))
								.addGap(18, 18, 18)
								.addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addComponent(jTextFieldAttachmentPath,
												javax.swing.GroupLayout.Alignment.TRAILING,
												javax.swing.GroupLayout.DEFAULT_SIZE, 205, Short.MAX_VALUE)
		...
		jPanel7Layout.setVerticalGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel7Layout.createSequentialGroup().addContainerGap()
						.addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jTextFieldAttachmentPath, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabel17).addComponent(jButtonBrowseAttachmentPath))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jTextFieldImagePath, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabel18).addComponent(jButtonBrowseImagePath))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel14)
								.addComponent(jTextFieldPandoc, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jButtonBrowsePandoc))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jCheckBoxUseXDGOpen).addContainerGap()));
		...
		jPanel4Layout.setVerticalGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel4Layout.createSequentialGroup().addContainerGap().addComponent(jCheckBoxAutoUpdate)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jCheckBoxCheckNightly).addContainerGap()));
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup()
						...
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jButtonCancel).addComponent(jButtonApply))
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
	...
	private javax.swing.JComboBox<String> jComboBoxBackgroundColors;
	private javax.swing.JComboBox<String> jComboBoxFonts;
	private javax.swing.JComboBox<String> jComboBoxIconTheme;
	private javax.swing.JComboBox<String> jComboBoxLAF;
	private javax.swing.JComboBox<String> jComboBoxLocale;
	private javax.swing.JComboBox<String> jComboBoxManualTimestamp;
	private javax.swing.JComboBox<String> jComboBoxShowAtStartup;
